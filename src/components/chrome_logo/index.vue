<template>
  <svg
    ...
    viewBox="0 0 192 192"
  >
    <defs><circle id="a" cx="96" cy="96" r="88" /></defs>
    ...
    <path clip-path="url(#b)" fill="url(#l)" d="M96 56v20.95L174.4 56z" />
    <g clip-path="url(#b)">
      <defs><path id="m" d="M21.97 8v40.34L61.36 116 96 56h88V8z" /></defs>
